    ...
    weeklyMeals: {
      'Poniedziałek': [
        ...
        },
        {
          ...
          ingredients: ['pierś z kurczaka', 'brokuły', 'marchewka', 'ryż brązowy']
        },
        {
          name: 'Kolacja',
          time: '19:00',
          ...
          ingredients: ['łosoś wędzony', 'mix sałat', 'awokado', 'pomidorki cherry']
        }
      ]
    },
    recommendations: [
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-blue-50">
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid gap-6 mb-8">
            ...
            <CardContent>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="text-center p-4 bg-green-50 rounded-lg">
                  <div className="text-2xl font-bold text-green-600">{mockPlan.dailyCalories}</div>
                  <div className="text-sm text-gray-600">kcal dziennie</div>
                </div>
                <div className="text-center p-4 bg-blue-50 rounded-lg">
                  <div className="text-2xl font-bold text-blue-600">{mockPlan.mealsPerDay}</div>
                ...
                <div className="text-center p-4 bg-orange-50 rounded-lg">
                  <div className="text-2xl font-bold text-orange-600">{mockPlan.weeklyGoal}</div>
          ...
          {Object.entries(mockPlan.weeklyMeals).map(([day, meals]: [string, any]) => (
            <Card key={day}>
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
