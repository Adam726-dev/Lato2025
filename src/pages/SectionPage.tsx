...
const SectionPage: React.FC = () => {
  ...
  const [travelViewMode, setTravelViewMode] = React.useState<
    "options" | "wizard" | "ai-planner"
  >("options");
  ...
  return (
    <div
      className={`relative min-h-screen ${
        sectionId === "dieta" || sectionId === "wakacje"
          ? "overflow-hidden"
          : ""
      } bg-gradient-to-br from-blue-50 via-white to-mint-50`}
    >
      ...
      {sectionId === "dieta" && (
        <>
          ...
          />
          <div className="fixed inset-0 bg-light-gray bg-opacity-40 z-10 pointer-events-none" />
        </>
      )}
      ...
      {/* Tło wideo gym.mp4 dla sekcji Siłownia */}
      {sectionId === "silownia" && (
        <>
          <video
            className="fixed inset-0 w-full h-full object-cover z-0  brightness-75"
      ...
      >
        ...
        <main className="max-w-7xl mx-auto px-4 py-8">
          <div className="mb-8">
            ...
            {!(
              sectionId === "wakacje" &&
              (travelViewMode === "wizard" || travelViewMode === "ai-planner")
            ) && (
              <div className="text-center">
